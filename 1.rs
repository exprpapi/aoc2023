...
fn main() {
  assert_eq!(sol_part1(INPUT_EXAMPLE_PART1), 142);
  assert_eq!(sol_part2(INPUT_EXAMPLE_PART2), 281);
  assert_eq!(sol_part1(INPUT_PART1), 54634);
  assert_eq!(sol_part2(INPUT_PART2), 53855);
}
...
static INPUT_EXAMPLE_PART2: &str = indoc::indoc!(r"
  two1nine
  eightwothree
  abcone2threexyz
  xtwone3four
